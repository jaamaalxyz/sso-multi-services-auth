...
export default function ServiceBHomePage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Service B...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-green-600 rounded-xl mb-6 shadow-lg">
            <span className="text-3xl font-bold text-white">B</span>
          </div>
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Service B</h1>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Service B - Current */}
            <div className="block p-6 border-2 border-green-400 bg-green-50 rounded-xl">
              <div className="text-center">
            ...
            <a
              ...
              className="group block p-6 border-2 border-purple-200 rounded-xl hover:border-purple-400 hover:shadow-lg transition-all duration-200"
            >
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-600 rounded-xl mx-auto mb-4 flex items-center justify-center group-hover:scale-105 transition-transform">
